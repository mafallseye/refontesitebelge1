...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'diayma_site_15cb23daa56ad9e87838_20251015111705_archive.zip';
        const ARCHIVE_SIZE       = '244346697';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '15cb23d-15111705';
        const SECONDARY_PACKAGE_HASH = 'edf7d90-15111705';
