...
<div class="w-full p-4 text-center bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="items-center justify-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4 rtl:space-x-reverse">
        ...
        <a href="#" class="w-full sm:w-auto no-underline bg-blue-700 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center px-4 py-2.5 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
            <!-- <svg class="me-3 w-7 h-7" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="google-play" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M325.3 234.3L104.6 13l280.8 161.2-60.1 60.1zM47 0C34 6.8 25.3 19.2 25.3 35.3v441.3c0 16.1 8.7 28.5 21.7 35.3l256.6-256L47 0zm425.2 225.6l-58.9-34.1-65.7 64.5 65.7 64.5 60.1-34.1c18-14.3 18-46.5-1.2-60.8zM104.6 499l280.8-161.2-60.1-60.1L104.6 499z"></path></svg> -->
            <div class="text-left rtl:text-right">
                <!-- <div class="mb-1 text-xs">Get in on</div> -->
                <div class="-mt-1 font-sans text-sm font-semibold uppercase">L’acidification des sols (pluies acides)</div>
            </div>
        </a>
        <a href="#" class="w-full sm:w-auto no-underline bg-blue-600 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center px-4 py-2.5 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
            <!-- <svg class="me-3 w-7 h-7" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="google-play" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M325.3 234.3L104.6 13l280.8 161.2-60.1 60.1zM47 0C34 6.8 25.3 19.2 25.3 35.3v441.3c0 16.1 8.7 28.5 21.7 35.3l256.6-256L47 0zm425.2 225.6l-58.9-34.1-65.7 64.5 65.7 64.5 60.1-34.1c18-14.3 18-46.5-1.2-60.8zM104.6 499l280.8-161.2-60.1-60.1L104.6 499z"></path></svg> -->
            <div class="text-left rtl:text-right">
                <!-- <div class="mb-1 text-xs">Get in on</div> -->
                <div class="-mt-1 font-sans text-sm font-semibold uppercase">La monoculture et le manque de diversité</div>
            </div>
        </a>
    </div>
</div>
...
<section class="bg-white dark:bg-gray-900  no-border">
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div class="mr-auto place-self-center lg:col-span-7">
            <h1 class="mb-2 text-3xl font-bold text-gray-900 dark:text-white">Le groupe Carmeuse (Terracalco), l’entreprise Irritec, Kijaniland et le label Agro-biovision (ABV) associent leur expertise dans le rendement des terres agricoles avec des solutions financières et des assurances.</h1>
            <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">L’amélioration de la productivité et la généralisation de meilleures pratiques seront la seule façon de rencontrer les besoins de sécurité alimentaire de ces pays.</p>
