<template>
  <div class="min-h-screen bg-slate-50 text-slate-800 font-sans">
    ...
    <header class="relative bg-gradient-to-r from-slate-900 via-indigo-950 to-slate-900 text-white overflow-hidden">
      <div class="absolute inset-0 opacity-20 bg-[url('https://unsplash.com')] bg-cover bg-center mix-blend-overlay"></div>
      <div class="max-w-7xl mx-auto px-6 py-24 md:py-32 relative z-10 flex flex-col items-start gap-4">
        <span class="bg-amber-500 text-slate-900 text-xs font-bold uppercase tracking-widest px-3 py-1 rounded-full shadow-sm">
    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse text-xs md:text-sm">
      ...
      <li aria-current="page">
        <div class="flex items-center gap-1">
          ...
          <span class="ms-1 font-medium text-slate-400 dark:text-slate-500 uppercase tracking-wider text-xs">Mission en
            Guinée conakry</span>
        </div>
      </li>
    </ol>
...
<section class="bg-slate-100 py-16">
  <div class="max-w-7xl mx-auto px-6">
    ...
    <div class="flex flex-wrap justify-center gap-2 mb-12 max-w-5xl mx-auto">
      <button 
        v-for="secteur in listeSecteurs" 
        :key="secteur"
        @click="secteurSelectionne = secteur"
        :class="[
...
<div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
  <div 
    v-for="(entreprise, index) in entreprisesFiltreesEtTriees" 
    :key="index" 
    class="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 border border-slate-200 flex flex-col justify-between"
  >
    <div>
      ...
      <div class="flex items-center justify-between gap-4 mb-4">
        ...
        <button 
          @click="secteurSelectionne = entreprise.secteur"
     ...
     <!-- PIED DE LA CARTE : ACTIONS SITE WEB & CONTACT EMAIL -->
            <div class="pt-4 border-t border-slate-50 dark:border-slate-700/50 mt-2 flex items-center justify-between gap-2">
              ...
              <a 
                ...
                :href="`mailto:${entreprise.email}?subject=Contact B2B - Mission Belge`"
              ...
              >
                <svg xmlns="http://w3.org" width="14" height="14" fill="currentColor" class="bi bi-envelope" viewBox="0 0 16 16">
      ...
      <div class="bg-gradient-to-br from-indigo-900 to-slate-900 rounded-3xl p-8 md:p-12 text-center text-white shadow-xl relative overflow-hidden">
        <div class="relative z-10 max-w-2xl mx-auto space-y-6">
          ...
          <div class="flex flex-wrap justify-center gap-4 pt-2">
            <a href="mailto:ivan@belemb.eu" class="bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold px-6 py-3 rounded-lg shadow-md transition-colors duration-200 text-sm">
