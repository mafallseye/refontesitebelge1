...
<!-- </div> -->
  ...
  <div class="bg-red-600 h-1.5 " style="width: 15%"></div>
    ...
    <blockquote>
        ...
        <p class="text-md italic font-medium text-gray-900 dark:text-white">" Le service économique et commercial Belge à Dakar est un service extérieur des gouvernements de Bruxelles-Capitale, de Flandre et de Wallonie. Il représente les trois agences régionales du commerce extérieur (Hub.Brussels, FIT et AWEX) et a pour juridiction le Sénégal, la Gambie, la Guinée, le Cap-Vert et la Guinée-Bissau. Le service économique et commercial apporte un soutien au développement international de toutes les entreprises du territoire Belge."</p>
    <p class="text-md italic font-medium text-gray-900 dark:text-white"> Le service Economique et Commercial ne s'occupe pas de Visas.</p>
    </blockquote>
