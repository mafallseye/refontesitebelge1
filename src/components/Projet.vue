...
<section class="bg-white dark:bg-gray-900  no-border">
    ...
    Le segment agricole subsaharien fait face à des défis majeurs suite aux :
            ...
            <a @click="ShowProjet()" class="w-full  no-underline sm:w-auto bg-gray-600 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center px-4 py-2.5 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
